...
*/
EIB7_ERR __cdecl EIB7GetDataFieldPtr(EIB7_HANDLE eib, void *data, EIB7_DataRegion region, EIB7_PositionDataField type, void **field, unsigned long *size);
...
EIB7_ERR __cdecl EIB7GetErrorInfo(EIB7_ERR code, char *mnemonic, unsigned long mnemlen, char *message, unsigned long msglen);
...
EIB7_ERR __cdecl EIB7GetHostIP(const char *hostname, unsigned long *ip);
...
EIB7_ERR __cdecl EIB7Open(unsigned long ip, EIB7_HANDLE *eib, long timeout, char *ident, unsigned long len);
...
EIB7_ERR __cdecl EIB7Close(EIB7_HANDLE eib);
...
EIB7_ERR __cdecl EIB7SetTimeout(EIB7_HANDLE eib, long timeout);
...
EIB7_ERR __cdecl EIB7GetConnectionStatus(EIB7_HANDLE eib, EIB7_CONN_STATUS* status);
...
/*! Returns the number of axes in the EIB.
    ...
    - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7GetNumOfAxes(EIB7_HANDLE eib, unsigned long* dsub, unsigned long* res1, 
...
/*! Returns one handle for every axis of the EIB. The number of axes depends on the type of the EIB.
    ...
    - EIB7_OutOfMemory if not enough memory was available
*/
EIB7_ERR __cdecl EIB7GetAxis(EIB7_HANDLE eib, EIB7_AXIS* set, unsigned long size, unsigned long* len);
...
/*! Returns one handle for every I/O port of the EIB. The number of ports depends on the type of the EIB.
    ...
    - EIB7_OutOfMemory if not enough memory was available
*/
EIB7_ERR __cdecl EIB7GetIO(EIB7_HANDLE eib,
...
*/
EIB7_ERR __cdecl EIB7SelectMode(EIB7_HANDLE eib, EIB7_OPERATING_MODE mode);
...
*/
EIB7_ERR __cdecl EIB7AddDataPacketSection(EIB7_DataPacketSection* packet, unsigned long index, 
...
*/
EIB7_ERR __cdecl EIB7ConfigDataPacket(EIB7_HANDLE eib, EIB7_DataPacketSection* packet, unsigned long size);
...
*/
EIB7_ERR __cdecl EIB7TransferRecordingData(EIB7_HANDLE eib, EIB7_MODE mode, unsigned long offset, unsigned long length);
...
*/
EIB7_ERR __cdecl EIB7GetRecordingStatus(EIB7_HANDLE eib, unsigned long* length, unsigned long* status, unsigned long* progress);
...
*/
EIB7_ERR __cdecl EIB7GetRecordingMemSize(EIB7_HANDLE eib, unsigned long* size);
...
*/
EIB7_ERR __cdecl EIB7SetNetwork(EIB7_HANDLE eib, unsigned long ip, unsigned long netmask, unsigned long gateway,
...
*/
EIB7_ERR __cdecl EIB7GetNetwork(EIB7_HANDLE eib, unsigned long *ip, unsigned long *netmask, unsigned long *gateway,
			EIB7_MODE *dhcp);
...
*/
EIB7_ERR __cdecl EIB7SetHostname(EIB7_HANDLE eib, const char *hostname);
...
*/
EIB7_ERR __cdecl EIB7GetHostname(EIB7_HANDLE eib, char *hostname, unsigned long len);
...
*/
EIB7_ERR __cdecl EIB7GetSerialNumber(EIB7_HANDLE eib, char *serial, unsigned long len);
...
*/
EIB7_ERR __cdecl EIB7GetIdentNumber(EIB7_HANDLE eib, char *ident, unsigned long len);
...
/*! Get the MAC address of the EIB ethernet interface in binary form
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7GetMAC(EIB7_HANDLE eib, unsigned char* mac);
...
*/
EIB7_ERR __cdecl EIB7GetVersion(EIB7_HANDLE eib, char * ident, unsigned long len, EIB7_FIRMWARE select);
...
/*! Get the boot mode of the last reboot.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7GetBootMode(EIB7_HANDLE eib, EIB7_BOOT_MODE *mode);
...
/*! Get the status of the last update attempt since last reboot.
  ...
  - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7UpdateState(EIB7_HANDLE eib, EIB7_UPDATE_STATUS *status);
...
/*! Get the number of currently open connections on the EIB
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7GetNumberOfOpenConnections(EIB7_HANDLE eib, unsigned long * cnt);
...
EIB7_ERR __cdecl EIB7GetTimestampTicks(EIB7_HANDLE eib, unsigned long * ticks);
...
EIB7_ERR __cdecl EIB7SetTimestampPeriod(EIB7_HANDLE eib, unsigned long period);
...
/*! Reset the Timestamp counter to zero
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7ResetTimestamp(EIB7_HANDLE eib);
...
EIB7_ERR __cdecl EIB7GetTimerTriggerTicks(EIB7_HANDLE eib, unsigned long * ticks);
...
*/
EIB7_ERR __cdecl EIB7SetTimerTriggerPeriod(EIB7_HANDLE eib, unsigned long period);
...
*/
EIB7_ERR __cdecl EIB7SetIntervalCounterTrigger(EIB7_HANDLE eib, EIB7_IntervalCounterMode mode, 
...
*/
EIB7_ERR __cdecl EIB7SetIntervalCounterInterpolation(EIB7_HANDLE eib, EIB7_IntervalCounterIPF ipf, 
...
*/
EIB7_ERR __cdecl EIB7OutputTriggerSource(EIB7_IO io, EIB7_OutputTriggerSrc src);
...
/*! Set trigger source for the axis
  ...
  - EIB7_ParamInvalid invalid trigger source
*/
EIB7_ERR __cdecl EIB7AxisTriggerSource(EIB7_AXIS axis, EIB7_AxisTriggerSrc src);
...
/*! Set trigger source for the auxiliary axis
  ...
  - EIB7_ParamInvalid invalid trigger source
*/
EIB7_ERR __cdecl EIB7AuxAxisTriggerSource(EIB7_HANDLE eib, EIB7_AxisTriggerSrc src);
...
/*! Set master trigger source
  ...
  - EIB7_ParamInvalid invalid trigger source
*/
EIB7_ERR __cdecl EIB7MasterTriggerSource(EIB7_HANDLE eib, EIB7_AxisTriggerSrc src);
...
/*! Enables or disables the trigger sources
  ...
  - EIB7_ParamInvalid invalid trigger source
*/
EIB7_ERR __cdecl EIB7GlobalTriggerEnable(EIB7_HANDLE eib, EIB7_MODE mode, unsigned long src);
...
*/
EIB7_ERR __cdecl EIB7ConfigPulsCounter(EIB7_HANDLE eib, EIB7_PulsCounterStart start, 
...
/*! Set the delay for trigger inputs
  ...
  - EIB7_ParamInvalid invalid parameter
*/
EIB7_ERR __cdecl EIB7SetTriggerInputDelay(EIB7_IO io, unsigned long dly);
...
/*! Set the active edge of the reference signal for triggering
  ...
  - EIB7_ParamInvalid invalid parameter
*/
EIB7_ERR __cdecl EIB7SetRITriggerEdge(EIB7_AXIS axis, EIB7_RITriggerEdge edge);
...
/*! Set the active edge of the reference signal for triggering for the auxiliary axis
  ...
  - EIB7_ParamInvalid invalid parameter
*/
EIB7_ERR __cdecl EIB7AuxSetRITriggerEdge(EIB7_HANDLE eib, EIB7_RITriggerEdge edge);
...
/*! Enable or disable the termination resistors for the incremental encoder inputs
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7EnableIncrementalTermination(EIB7_HANDLE eib, EIB7_MODE mode);
...
/*! Reset the EIB. After this call, all connections will be closed.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7Reset(EIB7_HANDLE eib);
...
/*! Copy data from the soft-realtime FIFO to destination memory. If the FIFO contains less
  ...
  valid data may be returned in that case. Check the 'entries' parameter.
*/
EIB7_ERR __cdecl EIB7ReadFIFOData(EIB7_HANDLE eib, void* data, unsigned long cnt,
			  unsigned long* entries, long timeout);
...
EIB7_ERR __cdecl EIB7ClearFIFO(EIB7_HANDLE eib);
...
/*! This call returns the size of a converted position data record.
  ...
  - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7SizeOfFIFOEntry(EIB7_HANDLE eib, unsigned long* size);
...
/*! This call returns the size of a raw position data record.
  ...
  - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7SizeOfFIFOEntryRaw(EIB7_HANDLE eib, unsigned long* size);
...
/*! This call returns the number of entries in the soft-realtime FIFO
  ...
  - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7FIFOEntryCount(EIB7_HANDLE eib, unsigned long* cnt);
...
/*! Initialize callback mechanism with user-defined function
  ...
  - EIB7_InvalidHandle if the EIB handle is not valid
*/
EIB7_ERR __cdecl EIB7SetDataCallback(EIB7_HANDLE eib, void* data, EIB7_MODE activate, unsigned long threshold, EIB7OnDataAvailable handler);
...
EIB7_ERR __cdecl EIB7InitAxis(EIB7_AXIS axis,
		      unsigned long iface,
...
/*! Resets the incremental counter for this axis. Generates an error if the
  ...
  - EIB7_ParamInvalid    parameter not valid 
*/
EIB7_ERR __cdecl EIB7ClearCounter(EIB7_AXIS axis);
...
/*! Returns the current position of the encoder. Returns an error if the EIB is not in polling mode.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7GetPosition(EIB7_AXIS axis, unsigned short *status, ENCODER_POSITION *pos);
...
EIB7_ERR __cdecl EIB7GetEncoderData(EIB7_AXIS axis,
...
EIB7_ERR __cdecl EIB7ClearPowerSupplyError(EIB7_AXIS axis);
...
EIB7_ERR __cdecl EIB7ClearLostTriggerError(EIB7_AXIS axis);
...
/*! Clears the error flags for the encoder. For incremental encoders only the amplitude
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7ClearEncoderErrors(EIB7_AXIS axis);
...
/*! The EnDat error messages will be cleared.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7ClearEnDatErrorMsg(EIB7_AXIS axis);
...
EIB7_ERR __cdecl EIB7ClearRefStatus(EIB7_AXIS axis);
...
EIB7_ERR __cdecl EIB7StartRef(EIB7_AXIS axis, EIB7_ReferencePosition ref);
...
EIB7_ERR __cdecl EIB7StopRef(EIB7_AXIS axis);
...
EIB7_ERR __cdecl EIB7GetRefActive(EIB7_AXIS axis, EIB7_MODE* active);
...
/*! Returns the current position of the EnDat 2.1 encoder. 
  ...
  - EIB7_InvalidInterface if the channel is configured for incremental encoder
*/
EIB7_ERR __cdecl EIB7EnDat21GetPosition(EIB7_AXIS axis, unsigned short *status, ENCODER_POSITION *pos);
...
*/
EIB7_ERR __cdecl EIB7EnDat21SelectMemRange(EIB7_AXIS axis, unsigned char mrs);
...
/*! Reads data from a specified encoder address
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat21ReadMem(EIB7_AXIS axis, unsigned char addr,  unsigned short *data);
...
/*! Resets the encoder
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat21ResetEncoder(EIB7_AXIS axis);
...
EIB7_ERR __cdecl EIB7EnDat22GetPosition(EIB7_AXIS axis, unsigned short* status, ENCODER_POSITION* pos,
...
/*! Returns the current position of the EnDat 2.2 encoder and selects a memory range. 
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat22SelectMemRange(EIB7_AXIS axis, unsigned short* status,
...
/*! Returns the current position of the EnDat 2.2 encoder and raed from selected memory area.
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat22ReadMem(EIB7_AXIS axis, unsigned short* status,
			    ENCODER_POSITION* pos, ENDAT_ADDINFO* ai1, ENDAT_ADDINFO* ai2,
			    unsigned char addr);
...
/*! Configures the additional information for an EnDat 2.2 encoder
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat22SetAddInfo(EIB7_AXIS axis, unsigned long addinfo1, unsigned long addinfo2);
...
/*! Configures the FIFO for the additional information for an EnDat 2.2 encoder
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7EnDat22SetAddInfoCycle(EIB7_AXIS axis, EIB7_MODE mode, unsigned char* data, unsigned long len);
...
/*! Returns the current absolute and incremental positions simultaneously.
  ...
  - EIB7_FuncNotSupp     function not supported 
*/
EIB7_ERR __cdecl EIB7ReadEnDatIncrPos(EIB7_AXIS axis,
...
/*! Enable or disable timestamps for the position values
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7SetTimestamp(EIB7_AXIS axis, EIB7_MODE mode);
...
EIB7_ERR __cdecl EIB7InitInput(EIB7_IO io, EIB7_IOMODE mode, EIB7_MODE termination);
...
/*! configure an I/O output channel 
  ...
  - EIB7_ParamInvalid    parameter not valid 
*/
EIB7_ERR __cdecl EIB7InitOutput(EIB7_IO io, EIB7_IOMODE mode, EIB7_MODE enable);
...
/*! Clears the amplitude error flag and the noise error flag
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxClearSignalErrors(EIB7_HANDLE eib);
...
/*! Clears the trigger lost error flag for the auxiliary axis.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxClearLostTriggerError(EIB7_HANDLE eib);
...
/*! Resets the counter for the auxiliary axis.
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxClearCounter(EIB7_HANDLE eib);
...
/*! Returns the status for the reference position latch procedure
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxGetRefActive(EIB7_HANDLE eib, EIB7_MODE* active);
...
/*! The reference position latch operation will be started
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxStartRef(EIB7_HANDLE eib);
...
/*! The reference position latch operation will be aborted
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxStopRef(EIB7_HANDLE eib);
...
*/
EIB7_ERR __cdecl EIB7AuxGetPosition(EIB7_HANDLE eib, unsigned short *status, ENCODER_POSITION *pos);
...
/*! Read the current position value and status information from the auxiliary axis.
  ...
  - EIB7_NotInitialized if the axis has not been initialized
*/  
EIB7_ERR __cdecl EIB7AuxGetEncoderData(EIB7_HANDLE eib,
			    unsigned short* status,
			    ENCODER_POSITION* pos,
...
/*! Enable or disable timestamps for the auxiliary axis
  ...
  - EIB7_ConnTimeout if the command did not complete in time
*/
EIB7_ERR __cdecl EIB7AuxSetTimestamp(EIB7_HANDLE eib, EIB7_MODE mode);
