...
for i in range(2*NIterations):
	if i%2 == 0:
		...
		openShutter()
		moveHorizontal(Move)
		time.sleep(CalcMovementTimeGeneral(Move,10000,10000,8000,1000)+deltaT)
		closeShutter()
		print "reached middle of" + str(i)
	elif i%2 == 1:
		openShutter()
		moveHorizontal(-(Move-50000))
		time.sleep(CalcMovementTimeGeneral((Move-50000),10000,10000,8000,1000)+deltaT)
		closeShutter()
