#ifndef __LINUX_COMMTCP__H__
#define __LINUX_COMMTCP__H__

/*! \file linux_commtcp.h
...
/*! An EIB_SOCKET is an integer in UNIX */
typedef int EIB_SOCKET;


#endif /*__LINUX_COMMTCP__H__*/
